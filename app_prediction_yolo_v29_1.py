# app_prediction_yolo_v29_1_com.py
# v29_1 = v29 + FIX UX "scroll/jump" dans Structure
# - L'édition des cases "Début" se fait dans un st.form => pas de rerun à chaque coche
# - Phase 1: scan rapide (compte/structure)
# - Phase 2: strict v27 après validation, optimisée (dpi detect + dpi 400 seulement si QR candidate)
...
# -----------------------------
def render_doc_page_to_rgb(doc: fitz.Document, page_index: int, dpi: int = 300) -> np.ndarray:
...
tmp_dir = Path("data/tmp_bv_v29_1_com")
...
# ==========================================================
# STRUCTURE (FIX UX) : édition dans un FORM
# ==========================================================
...
# ==========================================================
# PHASE 2 : strict v27 (optimisé) seulement si validation
# ==========================================================
if validate_seg:
    ...
    for i in range(n_pages):
        # 1) DPI bas: détecter QR candidate
        ...
        # 2) pas de candidate => pas de rerender DPI 400
        ...
        # 3) candidate => rerender DPI 400 + logique v27
