# app_prediction_yolo_v27_com.py
# v27 (basée sur v26_1_com)
# - "Résultats par page" escamotable (expander) après "Valider la segmentation"
# - Edition manuelle de invoice_amount + invoice_date dans "Résultats par facture"
# - Nouveau tableau "Transfert ERP" avec Date du jour, Heure, invoice_id, pages_count, has_bv,
#   bv_reference, invoice_amount, invoice_currency, invoice_date
...
tmp_dir = Path("data/tmp_bv_v27_com")
