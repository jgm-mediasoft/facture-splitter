# app_prediction_yolo_v26_1_com.py
# v26_1 (complet)
# - invoice_amount : affiché 2 décimales + couleur rouge si conf < 0.7 sinon vert
# - bv_amount : 2 décimales
# - amount_confidence : 4 décimales
# - bv_last_page : entier (Int64) => pas de ".0"
# - CSV export : reste numérique (df_invoices non formaté)
        ...
        invoices.append(
            {
                ...
                "has_bv": has_bv,
                "bv_last_page": last_bv_page,  # int/None
...
def reset_scan():
    for k in ["df_pages_editable", "df_final_pages", "df_final_invoices", "last_pdf_name"]:
...
tmp_dir = Path("data/tmp_bv_v26_1_com")
...
if recalc:
    ...
    # --- IMPORTANT : forcer bv_last_page en entier nullable (pas de .0) ---
...
if "df_final_pages" in st.session_state and "df_final_invoices" in st.session_state:
    ...
    df_invoices = st.session_state["df_final_invoices"].copy()
    ...
    # df_show = version "affichage" (strings), df_invoices reste numérique pour CSV
    df_show = df_invoices.copy()
    ...
    with d1:
        st.download_button(
            ...
            mime="text/csv",
            file_name=f"scan_v26_1_pages_{pdf_path.stem}.csv",
            use_container_width=True,
        )
    with d2:
        st.download_button(
            ...
            mime="text/csv",
            file_name=f"scan_v26_1_factures_{pdf_path.stem}.csv",
            use_container_width=True,
        )
    with d3:
        st.download_button(
            ...
            mime="text/csv",
            file_name=f"scan_v26_1_qr_ignores_{pdf_path.stem}.csv",
            use_container_width=True,
        )
